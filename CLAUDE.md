...
**Kullanıcıda bekleyenler:** SQL Editor'de `20260818010000_add_shared_expenses.sql` (Ortak Kasa). İsteğe bağlı TMDB "API Read Access Token". (Aile SQL'leri 20260720010000 + 20260720020000 uygulandı, kullanıcı 2026-07-24'te çalıştığını doğruladı.)
