...
**Kullanıcıda bekleyenler:** SQL Editor'de `20260819030000_add_trips.sql` (Seyahat modülü). İsteğe bağlı TMDB "API Read Access Token". 20260724010000, 20260818010000 ve 20260818020000 uygulandı; sertleştirme sonrası anon anahtarla yapılan yoklama fonksiyonların kapandığını doğruladı (permission denied). İsteğe bağlı TMDB "API Read Access Token". (Aile SQL'leri 20260720010000 + 20260720020000 uygulandı, kullanıcı 2026-07-24'te çalıştığını doğruladı.)
